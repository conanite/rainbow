...
public class Stack_D_A_A_d extends StackFunctionSupport {
  public Stack_D_A_A_d(InterpretedFunction original) {
    super(original.parameterList(), original.lexicalBindings, convert(original.lexicalBindings, original.body));
  }

  public Stack_D_A_A_d(ArcObject parameterList, Map lexicalBindings, Pair body) {
